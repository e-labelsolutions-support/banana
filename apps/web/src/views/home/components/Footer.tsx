...
const Footer = () => {
  const navigation = {
    documentation: [
      { name: t`Getting started`, href: "https://docs.banana.bn/introduction" },
      {
      ...
      },
      {
        ...
        href: "https://docs.banana.bn/api-reference/introduction",
      },
    ],
    company: [
      { name: t`Roadmap`, href: "/kan/roadmap" },
      { name: t`GitHub`, href: "https://github.com/kanbn/kan" },
      { name: t`Contact`, href: "mailto:support@banana.bn" },
