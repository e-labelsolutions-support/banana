      ...
      answer: (
        <Text>
          <Trans>
            ...
            step-by-step guide{" "}
            <Link
              href="https://docs.banana.bn/imports/trello"
              className="underline"
            >
              here
            </Link>
      ...
      answer: (
        <Text>
          <Trans>
            ...
            <Link href="https://banana.bn/kan" className="underline">
              banana.bn/kan
            </Link>
            , by going into your{" "}
            <Link href="https://banana.bn/settings" className="underline">
              workspace settings
            </Link>{" "}
      ...
      answer: (
        <Text>
          <Trans>
            ...
            <Link href="https://banana.bn/members" className="underline">
              members page
            </Link>{" "}
      ...
      <div className="flex flex-col items-center justify-center pb-12">
        ...
        <p className="text lg:text-md mt-3 max-w-[500px] text-center text-light-950 dark:text-dark-900">
          <Trans>
            ...
            <Link href="mailto:support@banana.bn" className="underline">
              contact us
            </Link>
            .
          </Trans>
